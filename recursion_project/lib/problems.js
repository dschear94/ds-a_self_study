...
function sumArray(array) {
    ...
    return array[0] + sumArray(newarr);
...
function flatten(data) {
    ...
    data.forEach(el => {
        let flatel = flatten(el);
        flattened.push(...flatel);
    });

    return flattened;
}

// let array_2 = ['this', ['problem', 'is'], [['pretty', 'tough'], [[':)']]]]

// console.log(flatten(array_2));
...
// console.log(Object.values(desktop));
console.log(Object.assign(Object.values(desktop)));
